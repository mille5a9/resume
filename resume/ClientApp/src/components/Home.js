    ...
    return (
        <div>
            ...
            <Col className="page-text" sm={8}>
                ...
                <p className="page-text-contact"><br/>Andrew Miller<br/>614-827-5168<br/>andrew.mille5a9@outlook.com<br /><a class="my-nav-btn" href="https://www.linkedin.com/in/andrew-miller-aa20a8148/" target="_blank" rel="noopener noreferrer">LinkedIn</a></p>
            </Col>
            <Col sm={2}></Col>
        </div>
    );
